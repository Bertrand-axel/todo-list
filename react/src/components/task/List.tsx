          ...
          {items.map((item) => (
            <tr key={item["@id"]}>
              ...
              <td>
                <Links
                  items={{
                    href: `/todo_lists/show/${encodeURIComponent(
                      item["todoList"]
                    )}`,
                    name: item["todoList"],
                  }}
              ...
              <td>
                <Link to={`/tasks/show/${encodeURIComponent(item["@id"])}`}>
                  <span className="fa fa-search" aria-hidden="true" />
                  <span className="sr-only">Show</span>
                </Link>
              </td>
              <td>
                <Link to={`/tasks/edit/${encodeURIComponent(item["@id"])}`}>
...
const List = () => {
  ...
  const id = (page && decodeURIComponent(page)) || "tasks";
